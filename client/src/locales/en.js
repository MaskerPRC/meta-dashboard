export default {
  ...
  home: {
    ...
    subtitle: '100 AI Products Challenge',
    challenge_title: '100 AI Products in One Year Challenge',
    description: 'Record the complete journey of every AI product from conception to launch, writing the innovation legend of the artificial intelligence era with code',
    ...
    challenge_manifesto: {
      ...
      quote: '"Before AI truly lets us do only what we want to do—let\'s first do something challenging enough for ourselves"',
  ...
  global_history: {
    ...
    subtitle: 'View progress history and important milestones of all projects',
    ...
    technical_issue: 'Technical Issue Encountered',
  ...
  about: {
    ...
    contact: {
      title: 'Contact Me',
      subtitle: 'For any ideas, suggestions or cooperation intentions, feel free to contact me anytime',
      email: 'Email',
      github: 'GitHub',
      wechat: 'WeChat',
      phone: 'Phone',
  ...
  admin: {
    ...
    subtitle: 'AI Project Dashboard Management Center',
